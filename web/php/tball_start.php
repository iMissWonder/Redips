...
exec("curl http://".$scrapydip.":6800/schedule.json -d project=taobaoCrawler -d spider=taobaoProSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
