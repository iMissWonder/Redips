...
exec("curl http://".$scrapydip.":61140/schedule.json -d project=taobaoCrawler -d spider=taobaoProSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
