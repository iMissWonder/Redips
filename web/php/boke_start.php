...
exec("curl http://".$scrapydip.":61140/schedule.json -d project=bodyExtract -d spider=bodyExtractIn -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
