...
exec("curl http://".$scrapydip.":61140/schedule.json -d project=JDSearch -d spider=jdSSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip." -d setting=TARGET=".$search,$out_redis);
...
exec("curl http://".$scrapydip.":61140/schedule.json -d project=JDSearch -d spider=jdSProSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
