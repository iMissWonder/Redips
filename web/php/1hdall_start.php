...
exec("curl http://".$scrapydip.":6800/schedule.json -d project=yhdCrawler -d spider=yhdProductSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
