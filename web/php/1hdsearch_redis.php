...
exec("curl http://".$scdHost.":".$scdPort."/schedule.json -d project=yhdSearch -d spider=yhdSSpider -d setting=MYSQL_HOST=".$sqlHost." -d setting=REDIS_HOST=".$rdsHost." -d setting=MYSQL_USER=".$sqlUser." -d setting=MYSQL_PASSWD=".$sqlPwd." -d setting=REDIS_PORT=".$rdsPort." -d setting=REDIS_PASSWORD=".$rdsPwd." -d setting=TARGET=".$keyWd,$out);
