...
exec("curl http://".$scrapydip.":61140/schedule.json -d project=yhdCrawler -d spider=yhdProductSpider -d setting=MYSQL_HOST=".$mysqlip." -d setting=REDIS_HOST=".$redisip,$out);
